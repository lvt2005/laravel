...
return new class extends Migration
{
    ...
    {
        Schema::table('forum_report', function (Blueprint $table) {
    ...
    {
        Schema::table('forum_report', function (Blueprint $table) {
            $table->dropForeign('forum_report_comment_id_foreign');
            $table->dropForeign('forum_report_post_id_foreign');
            $table->dropForeign('forum_report_user_id_foreign');
        });
    }
};
