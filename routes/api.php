...
Route::get('/appointments/check-patient', [ProfileController::class, 'checkPatientAppointment']);
...
Route::middleware(['jwt.custom'])->group(function () {
    ...
    Route::get('/doctors/{id}', [ProfileController::class, 'getDoctor']);
    ...
    Route::middleware(['role:ADMIN'])->prefix('admin')->group(function () {
        ...
        Route::get('/forum-reports', [SystemSettingsController::class, 'getForumReports']);
