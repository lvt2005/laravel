...
<body>
        ...
        <nav class="header-nav">
            ...
            <div class="logo-section">
                <a href="/" title="Về trang chủ">
                    <img src="{{ asset('frontend/img/logomau.jpg') }}" alt="Logo" class="logo-img" />
                </a>
            </div>
            ...
            <ul id="menu-menu-main" class="menu-list">
                ...
                <li
                    ...
                    <a class="menu-link" href="#services-section" title="Dịch Vụ">Dịch Vụ</a>
                    <i class="bx bxs-chevron-down"></i>
                    <ul class="child" id="menuServices">
                        <li><a class="menu-link" href="#services-section">Xem tất cả dịch vụ</a></li>
                    </ul>
                </li>
                ...
                <li
                    class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-dropdown">
                    <a class="menu-link" href="#" title="Hướng Dẫn Khách Hàng">Hướng Dẫn</a>
                    <i class="bx bxs-chevron-down"></i>
                    <ul class="child">
                        <li>
                            <a class="menu-link" href="/huong-dan/bang-gia-tien-giuong">Bảng Giá Tiền Giường</a>
                        </li>
                        <li>
                            <a class="menu-link" href="/huong-dan/bao-hiem-y-te">Bảo Hiểm Y Tế</a>
                        </li>
                        <li>
                            <a class="menu-link" href="/huong-dan/quyen-va-nghia-vu">Quyền và Nghĩa Vụ Của Người Bệnh</a>
                        </li>
                        <li>
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-page">
                    <a class="menu-link" href="/dat-lich" title="Đặt Lịch Khám">Đặt lịch khám</a>
                </li>
            </ul>
            ...
            <div class="header-right">
                ...
                <!-- Đặt lịch ngay button (hidden when logged in) -->
                <a href="/dat-lich/bieu-mau" class="btn-header-primary" id="bookNowBtn">Đặt lịch ngay</a>
                
                <!-- Login Button (shown when not logged in) -->
                <a href="/dang-nhap" class="btn-header-outline" id="loginBtn">Tài khoản</a>
            ...
            <div class="header-left">
                ...
                <div class="header-boxes-secondary">
                    ...
                    <div class="header-box-small compact">
                        <h3>Chào mừng bạn đến Hệ thống Đặt lịch Hẹn</h3>
                        <p>
                            Đặt hẹn trực tuyến dễ dàng với bác sĩ phù hợp, hỗ trợ khẩn cấp
                            24/7 qua hotline.
                        </p>
                        <div class="hotline">
                            <a href="tel:18006767" class="hotline-btn">
                                Hotline: 1800 6767</a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        async function fetchDoctors(page = 1) {
            ...
            container.innerHTML = '<div style="text-align:center;padding:40px;color:#666;grid-column:1/-1;"><i class="fas fa-spinner fa-spin" style="font-size:24px;margin-bottom:10px;display:block;"></i>Đang tải danh sách bác sĩ...</div>';
            ...
            try {
                ...
                if (data.data && data.data.length > 0) {
                    ...
                    container.innerHTML = '<div style="text-align:center;padding:40px;color:#666;grid-column:1/-1;"><i class="fas fa-user-md" style="font-size:40px;margin-bottom:15px;display:block;color:#ccc;"></i>Hiện chưa có bác sĩ nào trong hệ thống</div>';
                    updatePagination();
                }
            } catch (error) {
                console.error('Error fetching doctors:', error);
                container.innerHTML = '<div style="text-align:center;padding:40px;color:#e74c3c;grid-column:1/-1;"><i class="fas fa-exclamation-circle" style="font-size:40px;margin-bottom:15px;display:block;"></i>Không thể tải danh sách bác sĩ. Vui lòng thử lại sau.</div>';
            } finally {
                isLoading = false;
            }
        }
        ...
        function renderDoctors() {
            ...
            if (allDoctors.length === 0) {
                container.innerHTML = '<div style="text-align:center;padding:40px;color:#666;grid-column:1/-1;">Không có bác sĩ nào</div>';
                return;
            }
            ...
            container.innerHTML = allDoctors.map(doctor => {
                ...
                return `
                    <div class="doctor-card" data-id="${doctor.id}" onclick="viewDoctorDetail(${doctor.id})" style="cursor:pointer;">
                        <div class="img-wrap">
        ...
        async function loadSpecializations() {
            ...
            try {
                ...
                if (result.success && result.data && result.data.length > 0) {
                    ...
                    result.data.slice(0, 8).forEach((spec, index) => {
                        const iconClass = specializationIcons[index % specializationIcons.length];
                        const slug = spec.name.toLowerCase()
                            .normalize('NFD').replace(/[\u0300-\u036f]/g, '')
                            .replace(/đ/g, 'd').replace(/Đ/g, 'D')
                            .replace(/\s+/g, '-');
                        
                        // Sử dụng hình ảnh từ API nếu có, không thì dùng default
                        const imageUrl = spec.image_url || defaultImages[index % defaultImages.length];
                        
                        // Card với hình ảnh
                        if (index % 2 === 0) {
                            html += `
                                <div class="card full-img">
                                    <img src="${imageUrl}" alt="${spec.name}" />
                                </div>
                            `;
                        }
                        ...
                        // Thêm ảnh sau mỗi 2 card
                        if (index % 2 === 1) {
                            const nextImageUrl = result.data[index + 1]?.image_url || defaultImages[(index + 1) % defaultImages.length];
                            html += `
                                <div class="card full-img">
                                    <img src="${nextImageUrl}" alt="Chuyên khoa" />
                                </div>
                            `;
                        }
                    });
                    ...
                    <div class="service-card">
                        ...
                        <div class="service-content">
                            ...
                            <ul class="service-features">
                                <li><i class="bx bx-check-circle"></i> Đội ngũ bác sĩ chuyên nghiệp</li>
                                <li><i class="bx bx-check-circle"></i> Thiết bị hiện đại</li>
                                <li><i class="bx bx-check-circle"></i> ${duration || 'Thời gian linh hoạt'}</li>
                            </ul>
                            <div class="service-price">
                                ...
                                <a href="${bookingUrl}" class="btn-book">Đặt Lịch</a>
                            </div>
                        </div>
                    </div>
                `;
