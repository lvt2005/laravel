...
<body>
  ...
  <div class="verification-modal" id="verificationModal">
    <div class="verification-box">
      ...
      <div class="verification-actions">
        ...
        <button class="btn-verify" id="btnVerify" onclick="verifyCode()">Xác nhận</button>
      </div>
  ...
  <script>
    ...
    function autoFillFromLogin() {
      ...
      if (token && userDataStr) {
        try {
          ...
          console.log('Auto-fill userData:', userData);
    ...
    async function resendVerificationCode() {
      ...
      try {
        const response = await fetch(`${API_BASE}/public/send-booking-code`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ email: pendingBookingData.patient_email })
        });
    ...
    async function submitBooking() {
      ...
      console.log('Submitting booking with data:', pendingBookingData);
